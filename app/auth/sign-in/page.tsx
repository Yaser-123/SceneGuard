  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="relative hidden w-1/2 overflow-hidden lg:flex lg:items-center lg:justify-center lg:p-12">
        {/* Gradient background */}
        <div className="absolute inset-0 bg-linear-to-br from-slate-900 via-blue-900 to-background opacity-50"></div>
          ...
          <div className="w-full space-y-3">
            <div className="rounded border border-accent/20 bg-slate-900/40 p-4 backdrop-blur-sm hover:border-accent/40 transition-colors">
              <div className="flex items-start gap-3">
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded text-xs font-bold text-accent">1</span>
                <span className="text-sm text-foreground">Analyze scene feasibility</span>
              </div>
            </div>
            <div className="rounded border border-accent/20 bg-slate-900/40 p-4 backdrop-blur-sm hover:border-accent/40 transition-colors">
              <div className="flex items-start gap-3">
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded text-xs font-bold text-accent">2</span>
                <span className="text-sm text-foreground">Identify production risks & cost drivers</span>
              </div>
            </div>
            <div className="rounded border border-accent/20 bg-slate-900/40 p-4 backdrop-blur-sm hover:border-accent/40 transition-colors">
              <div className="flex items-start gap-3">
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded text-xs font-bold text-accent">3</span>
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-300">
              Sign in to your SceneGuard workspace
            </p>
          </div>
